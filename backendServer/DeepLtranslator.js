...
class DeepL {
    constructor() {
        ...
        this.originalLanguage = userSettings.DeepL.originalLanguage
        this.translationLanguage = userSettings.DeepL.translationLanguage
        this.inputTextboxID = userSettings.DeepL.inputTextboxID
        this.resultTextboxID = userSettings.DeepL.resultTextboxID
        this.initialPhrase = userSettings.DeepL.initialPhrase
    ...
    async activate() {
        ...
        await this.page.goto(`https://www.deepl.com/en/translator#${this.originalLanguage}/${this.translationLanguage}/`);
    ...
    async translate(originalLanguage, targetLanguage, textToBeTranslated) {
        ...
        await this.page.goto(`https://www.deepl.com/en/translator#${this.originalLanguage}/${this.translationLanguage}/`+textToBeTranslated);
    }
    ...
    grabCopiedTextThenTranslate(originalLanguageCode, copiedText) {
        this.originalLanguage = originalLanguageCode
